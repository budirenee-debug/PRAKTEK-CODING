...
setlocal
chcp 65001 >nul
title B_gadget POS - Localhost + Tunnel

:: ==========================================================
::  B_gadget POS - Tunnel Runner (LOKAL + PUBLIK)
...
::  - Untuk Windows dev yang butuh akses publik
::  - Untuk Ubuntu Server pakai run-tunnel.sh
:: ==========================================================
...
echo ========================================
echo  B_gadget POS - Tunnel Runner
echo  Root   : %ROOT%
