...
- **Detail read-only tab terminal (belum uji browser):** tombol Detail di Bisa Diambil / Sudah Diambil / Failed / Garansi / Pendapatan buka modal info saja (tanpa kotak edit, tanpa Assign/Simpan/Ubah Estimasi). Proses & Semua Service tetap bisa edit. `?v=multistore-detail-ro`.
